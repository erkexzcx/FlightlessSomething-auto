...
Go to https://github.com/erkexzcx/FlightlessSomething-auto/actions, on the left side there would be action named `Benchmark BG3`, click on it and then `Run workflow` button. For the most part it should work.
